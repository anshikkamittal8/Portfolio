...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'anshikkamittal8@gmail.com',
    href: 'mailto:anshikkamittal8@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 77355 15342',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/917735515342',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/anshikka-mittal-59728428a',
    href: 'https://www.linkedin.com/in/anshikka-mittal-59728428a/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@anshikkamittal8',
    href: 'https://github.com/anshikkamittal8',
  },
];
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            © 2026 Anshikka Mittal
          </span>
          <span
            className="font-light uppercase tracking-widest text-[#D7E2EA]/50"
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Designed & built by Anshikka
          </span>
        </div>
      </FadeIn>
    </section>
