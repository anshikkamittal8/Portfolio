...
const ABOUT_TEXT =
  "Hi, I'm Anshikka Mittal — a Computer Science student passionate about full-stack development and AI-powered applications. I enjoy building scalable, user-focused products using technologies like React, Next.js, Node.js, PostgreSQL, and modern AI tools. I've worked on projects ranging from e-commerce platforms to AI-driven recommendation systems, with a focus on creating seamless user experiences and real-world impact. I'm always exploring new technologies, improving my problem-solving skills, and growing as a developer.";
