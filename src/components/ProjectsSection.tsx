...
const PROJECTS: ProjectData[] = [
    {
        ...
        category: 'College',
        name: 'ClubVerse',
        liveUrl: 'https://club-verse-zeta.vercel.app/',
        col1Image1: '/clubverse-hero.png',
        col1Image2: '/clubverse-main.png',
        col2Image: '/clubverse-faculty.png',
      },
  {
      number: '02',
      category: 'Client-Project',
      name: 'PrachiCreations',
      liveUrl: 'https://prachicreations.me',
      col1Image1: '/prachi-hero.png',
      col1Image2: '/prachicreations.png',
      col2Image: '/prachicreations2.png',
    },
  {
    number: '03',
    category: 'Internship',
    name: 'Credit Management System',
    liveUrl: 'https://cp.jaiprakashhospitals.com/credit-system/',
    col1Image1: '/cms.png',
    col1Image2: '/cms-login.png',
    col2Image: '/cms-admin.png',
  },
  {
    number: '04',
    category: 'Client Project',
    name: 'Aadhar Vault',
    liveUrl: 'https://hotel-maharaja.vercel.app/',
    col1Image1: '/aadhar.png',
    col1Image2: '/adhar-login.png',
    col2Image: '/adhar-submission.png',
  },
];
